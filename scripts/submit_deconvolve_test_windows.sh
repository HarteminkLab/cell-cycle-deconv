...
sbatch -a 0-3%3 -D ./slurm-logs/ --job-name="g1" -p compsci --export="PYFILE=src/deconvolve_gamma_search_genome.py,ARGS=$ARGS,BATCH=0" scripts/cpu_genomicarray_job.sh
