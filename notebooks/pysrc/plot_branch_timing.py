...
class BranchPlotter:
    ...
    def __init__(self):
        ...
        self.g1 = self.lambd*gamma1
        self.s = self.lambd*gamma2-self.g1
        self.g2m = self.lambd-self.g1-self.s
        
        self.daughter_delay = 10
    ...
    def plot_mass(self, ax, experimental_time, translate=False):
        ...
        for g_r in G_R_MAP.keys():
            ...
            mass = norm(loc=meanG, scale=std).pdf(x)*2
    ...
    def plot_gen(self, ax):
        ...
        self.plot_cohort_translated(ax, (0, 0), 0)
        self.plot_cohort_translated(ax, (0, 0), 1)
        self.plot_cohort_translated(ax, (0, 0), 2)

        self.plot_cohort_translated(ax, (1, 2), 0)

        self.plot_cohort_translated(ax, (1, 1), 0)
        self.plot_cohort_translated(ax, (1, 1), 1)

        self.plot_cohort_translated(ax, (2, 2), 0)
