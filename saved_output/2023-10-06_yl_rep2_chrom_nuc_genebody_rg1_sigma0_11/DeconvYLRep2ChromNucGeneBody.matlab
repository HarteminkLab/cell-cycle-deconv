% Configuration for Yulong 2018 Replicate 2 Dataset Chromatin nucleosome gene body occupancy
...
classdef Deconv
	properties (Constant)
		...
		DECONV_DATASET = 'datasets/yl_cell_cycle/chromatin/yl_rep2_chromatin_occupancy_for_deconv_2023_10_06/';

		DECONV_WT1 = 'WT1';
		DECONV_WT2 = 'WT2';
		DECONV_JOINT = 'JOINT';

		DATA_WT1 = strcat(Deconv.DECONV_DATASET, 'chrom_yl_rep2_gb_nuc_occ.tsv');
		DATA_WT2 = strcat(Deconv.DECONV_DATASET, 'chrom_yl_rep2_gb_nuc_occ.tsv');
