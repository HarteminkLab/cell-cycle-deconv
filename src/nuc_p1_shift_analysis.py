...
# Old analysis, may revisit, some things have changed about the deconvolution, but this still 
# may work. I have found that plus one calling and shift can be tricky and less of a reliable
# signal than other measures. 4/1/25
