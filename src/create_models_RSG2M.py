...
# Idea: Create a model that has an independent recovery branch separate from the mother and daughter branches
# The mother and daughter branches remain sharing the "Shared-G1".
#
# Recovery R-G1, R-S and R-G2M (dubbed R-postG1) will be independent from
# the mother and daughter branch's G1, and postG1 phases.
#
# This is a trial to determine if this model change will resolve the issues with a shared postG1 in recovery.
#       Manifested as elevated and disjointed CG1 occupancy and low RG1 occupancy when there are differences
#       between recovery postG1 and mother/daughter postG1.
#
	...
	def create_model_rg1_model(self):
		...
		print OUT <<DIFF_G1;
				"1.2.1":{
					...
					"RpostG1":[{"t":["lambda*beta","-alpha+lambda","$diff_g1_postg1"]},
