function drawCheck4Mutant(dataset, f_file, gm_file)
...
out_fid = fopen('Final_check_mutant.lst', 'w');
...
if nargin < 3
	error('... Expect 3 inputs: dataset, f_file, gm_file');
end
...
for idx = 1:1:num_genes;
	...
	disp(sprintf('%d\t:\t%0.3f (%s)', idx, rn, genes{idx}));
