function [model] = drawImages4Mutant(imagedir, dataset, f_file, gm_file)
...
if nargin < 4
	error('... Expect 4 inputs: imagedir, dataset, f_file, gm_file');
end
...
%	[orfname, orfid] = map2SystemNames(names{i});
	...
	plotOptimal_general_branch4Mutant(model, 1, imagedir);
end
