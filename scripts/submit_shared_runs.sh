...
OUTDIR=output/deconvolve_sharedg1_g0066_11x11_2024_09_12
...
# array index
sbatch -a 0-999%6 -D ./slurm-logs/ --job-name="shar_1" -p compsci --export="PYFILE=src/deconvolve_combined_runner.py,ARGS=$ARGS,BATCH=0" scripts/cpu_genearray_job.sh
sbatch -a 0-999%6 -D ./slurm-logs/ --job-name="shar_2" -p compsci --export="PYFILE=src/deconvolve_combined_runner.py,ARGS=$ARGS,BATCH=1" scripts/cpu_genearray_job.sh
sbatch -a 0-999%6 -D ./slurm-logs/ --job-name="shar_3" -p compsci --export="PYFILE=src/deconvolve_combined_runner.py,ARGS=$ARGS,BATCH=2" scripts/cpu_genearray_job.sh
