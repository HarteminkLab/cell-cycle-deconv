function [model] = plotOptimal_general_branch_line(model, fig_flag, imagedir)
...
%		end
		...
		if strcmp(model.datatype, DECONV_JOINT)
			...
			subplot(2,1,1);
			my_gray = [211 211 211]./255;
			if logspace
				semilogy(tm1, g1, '-o', 'LineWidth', 3, 'color', 'r', 'MarkerFaceColor', my_gray, 'MarkerSize', 8);
			else
				plot(tm1, g1, '-o', 'LineWidth', 3, 'color', 'r', 'MarkerFaceColor', my_gray, 'MarkerSize', 8);
			end
			hold on;
			if logspace
				semilogy(tm1, pred_g1, '-o', 'LineWidth', 2, 'color', 'g', 'MarkerFaceColor', my_gray, 'Markersize', 8);
			else
				plot(tm1, pred_g1, '-o', 'LineWidth', 2, 'color', 'g', 'MarkerFaceColor', my_gray, 'Markersize', 8);
			end
			...
			legend('wild-type 1', 'deconv fitting', 'Location', 'Best');

			subplot(2,1,2);
			if logspace
				semilogy(tm2, g2, '-o', 'LineWidth', 3, 'color', 'r', 'MarkerFaceColor', my_gray, 'Markersize', 8);
			else
				plot(tm2, g2, '-o', 'LineWidth', 3, 'color', 'r', 'MarkerFaceColor', my_gray, 'Markersize', 8);
			end
			hold on;
			if logspace
				semilogy(tm2, pred_g2, '-o', 'LineWidth', 2, 'color', 'g', 'MarkerFaceColor', my_gray, 'Markersize', 8);
			else
				plot(tm2, pred_g2, '-o', 'LineWidth', 2, 'color', 'g', 'MarkerFaceColor', my_gray, 'Markersize', 8);
			end
			...
			legend('wild-type 2', 'deconv fitting', 'Location', 'Best');
		else
			g = model.g;
			pred_g = model.H * model.f;
